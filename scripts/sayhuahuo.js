const rules = {
    name: "【花火论坛】： ",
    url: "https://www.sayhuahuo.net/dsu_paulsign-sign.html", //用于获取formhash的链接
    ...
    op: [{
        ...
        method: "post", 
        ua: "pc",
        url: "https://www.sayhuahuo.net/plugin.php?id=dsu_paulsign:sign&operation=qiandao&infloat=1&inajax=1", //签到链接
