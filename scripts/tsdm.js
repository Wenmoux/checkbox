const rules = {
    ...
    url: "https://www.tsdm39.net/plugin.php?id=dsu_paulsign:sign&mobile=yes", //用于获取formhash的链接     
    formhash: 'formhash=(.+?)\&', //formhash正则
    verify: "您需要先登录才能继续本操作", //验证cookie状态
    op: [{
            name: "签到",
            method: "post",
            url: "https://www.tsdm39.net/plugin.php?id=dsu_paulsign:sign&operation=qiandao&infloat=0&inajax=0&mobile=yes", //签到链接
