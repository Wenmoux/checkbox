...
typeid = 1001; //打码识别类型
answer = null;
username =require("../config.json").ym3fd.username
password=require("../config.json").ym3fd.password
lzusername = require("../config.json").ym3fd.lzusername //联众账号
lzpassword = require("../config.json").ym3fd.lzpassword //联众密码
